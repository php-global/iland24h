...
OrderController = {
    ...
    events: {
        ...
        loadCountsByCategoriesId: function (dataId, orderDetail) {
            ...
            if (categoriesId != "") {
                ...
                $.ajax({
                    type: 'POST',
                    dataType: 'JSON',
                    url: '/Order/LoadCountsByCategoriesId',
        ...
        loadSizesByCategoriesIdAndCountId: function (dataId, orderDetail) {
            ...
            if (categoriesId != "") {
                ...
                $.ajax({
                    type: 'POST',
                    dataType: 'JSON',
                    url: '/Order/LoadSizesByCategoriesIdAndCountId',
        ...
        loadItemsByCategoriesIdAndCountIdAndSizeId: function (dataId, orderDetail) {
            ...
            if (categoriesId != "") {
                ...
                $.ajax({
                    type: 'POST',
                    dataType: 'JSON',
                    url: '/Order/LoadItemsByCategoriesIdAndCountIdAndSizeId',
        ...
        checkValidDatePlanShip: function (event) {
            ...
            $.ajax({
                url: "/Order/CheckValidDatePlanShip",
                type: "POST",
